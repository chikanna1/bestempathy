    ...
    <div className="">
      ...
      <div className="px-[12.5%] pt-[2%]">
        <div className="terms-of-service-page-container">
          <h1 className="text-center text-[40px] mb-[5%] font-bold">
            Terms Of Service
          </h1>
          <p className="py-2 text-[16px]">
            This website is operated by Best Empathy. Throughout the site, the
            terms “we”, “us” and “our” refer to Best Empathy. Best Empathy
          ...
          <h2 className="text-[25px] font-semibold text-center lg:text-left pt-3">
            SECTION 1 - ONLINE WEB SERVICE TERMS
          </h2>
          <hr className="py-2" />
          ...
          <p className="py-2 text-[16px]">
            We reserve the right to refuse our service to anyone for any reason
            at any time.
          </p>
          ...
          <p className="py-2 text-[16px]">
            Prices for our service offerings are subject to change without
            notice.
          </p>
          ...
          <p className="py-2 text-[16px]">
            Certain products/services may be available exclusively online
            through the website. Our Listing Service is Non-Refundable after the
            30 day Grace Period. After that, your billing is subject to Yearly
            or Monthly depending on the plan you have chosen. You reserve the
            right to cancel at any time.
          </p>

          <p className="py-2 text-[16px]">
            We have made every effort to display as accurately as possible the
            colors and images of our products/services that appear on the
            ...
            descriptions of products/services or pricing are subject to change
          ...
          <p className="py-2 text-[16px]">
            ...
            see <Link href="/privacy-policy">Best Empathy Privacy Policy</Link>
          </p>
          ...
          <p className="py-2 text-[16px]">
            ...
            non-infringement. In no case shall Best Empathy, our directors,
          ...
          <p className="py-2 text-[16px]">
            You agree to indemnify, defend and hold harmless Best Empathy and
          ...
          <div className="contact-info">
            <p className="text-[16px]">Best Empathy</p>
            <p className="text-[16px]">support@bestempathy.com</p>
            <p className="text-[16px]">2578 Broadway #607 New York, NY 10025</p>
          </div>
        </div>
      </div>
      <Footer />
