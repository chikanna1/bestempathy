...
export const therapistDemographics = [
  { value: "asian", label: "Asian" },
  { value: "blackOrAfrican", label: "Black/African" },
  {
    value: "americanIndianOrAlaskaNative",
    label: "American Indian/Alaska Native",
  },
  { value: "latin", label: "Latin/Latino" },
  ...
  { value: "arabOrMiddleEastern", label: "Arab/Middle Eastern" },
  { value: "mixedRace", label: "Mixed Race" },
];

export const religiousPreferences = [
