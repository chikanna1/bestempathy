...
function LocationInput({ values, setValues }) {
    ...
    <div>
      <div className="flex flex-row items-center ">
        <input
          ...
          className="rounded-md py-3 px-10 min-w-[200px] w-[100%] focus:outline-gray-600 focus:bg-white outline outline-2 outline-gray-400"
        />
