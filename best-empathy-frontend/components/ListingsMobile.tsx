...
export default function ({
            ...
            {therapists.length > 0 ? (
              ...
              <div className="text-center mt-10">
                <p className="capitalize font-bold italic">
                  No therapists matched your search query. Please revise your
                  search parameters
                </p>
              </div>
            )}
  ...
  const Map = () => (
    <div className="px-[5%]">
      <div
        className={`flex flex-col bg-white p-4 border-blue-gray-50 border rounded-md `}
      >
        {/* Keywords Input */}
  ...
  const [componentToDisplay, setComponentToDisplay] = useState("map");
